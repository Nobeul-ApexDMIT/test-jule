      ...
      <ul class="nav nav-primary mt-0">
        ...
        @if (empty($admin->role) || (!empty($permissions) && in_array('Home Page Sections', $permissions)))
          ...
          <li class="nav-item @if (request()->routeIs('admin.home_page.hero.static_version')) active
            ...
            @elseif (request()->routeIs('admin.home_page.room_latest_section')) active
            @elseif (request()->routeIs('admin.home_page.package_category_section')) active
            @elseif (request()->routeIs('admin.home_page.package_latest_section')) active
          ...
          >
            ...
            <div id="home_page" class="collapse
              ...
              @elseif (request()->routeIs('admin.home_page.room_latest_section')) show
              @elseif (request()->routeIs('admin.home_page.package_category_section')) show
              @elseif (request()->routeIs('admin.home_page.package_latest_section')) show
            ...
            >
              <ul class="nav nav-collapse">
                <li class="submenu">
                  ...
                  >
                    <ul class="nav nav-collapse subnav">
                      @if($settings->theme_version == 'multipurpose' || $settings->theme_version == 'multipurpose_two' )
                 ...
                 @if($settings->theme_version == 'theme_five' || $settings->theme_version == 'theme_four' || $settings->theme_version == 'theme_three' || $settings->theme_version == 'multipurpose' || $settings->theme_version == 'multipurpose_two')
                ...
                @endif
                 @if($settings->theme_version == 'theme_fo')
                ...
                @endif
                 @if($settings->theme_version == 'theme_five' || $settings->theme_version == 'theme_four' || $settings->theme_version == 'multipurpose' || $settings->theme_version == 'multipurpose_two')
                <li class="{{ request()->routeIs('admin.home_page.room_section') ? 'active' : '' }}">
                  <a href="{{ route('admin.home_page.room_section') . '?language=' . $defaultLang->code }}">
                    <span class="sub-item">{{ __('Feature Room Section') }}</span>
                  </a>
                </li>
                @endif
                ...
                <li class="{{ request()->routeIs('admin.home_page.room_category_section') ? 'active' : '' }}">
                  ...
                  <li class="{{ request()->routeIs('admin.home_page.room_latest_section') ? 'active' : '' }}">
                  <a href="{{ route('admin.home_page.room_latest_section') . '?language=' . $defaultLang->code }}">
                    <span class="sub-item">{{ __('Latest Room Section') }}</span>
                  </a>
                </li>
                 @endif
                 @if($websiteInfo->theme_version == "theme_three")
                <li class="{{ request()->routeIs('admin.home_page.package_category_section') ? 'active' : '' }}">
                  <a href="{{ route('admin.home_page.package_category_section') . '?language=' . $defaultLang->code }}">
                    <span class="sub-item">{{ __('Package Category Section') }}</span>
                  </a>
                </li>
                <li class="{{ request()->routeIs('admin.home_page.package_latest_section') ? 'active' : '' }}">
                  <a href="{{ route('admin.home_page.package_latest_section') . '?language=' . $defaultLang->code }}">
                    <span class="sub-item">{{ __('Latest Package Section') }}</span>
                  </a>
                </li>
                @endif
               
                @if($settings->theme_version == 'multipurpose' || $settings->theme_version == 'theme_four' || $settings->theme_version == 'multipurpose_two' || $settings->theme_version == 'theme_three')
                <li class="{{ request()->routeIs('admin.home_page.package_section') ? 'active' : '' }} ">
                  <a href="{{ route('admin.home_page.package_section') . '?language=' . $defaultLang->code }}">
                    <span class="sub-item">{{ __('Feature Package Section') }}</span>
                  </a>
                </li>
                @endif
                 @if($settings->theme_version == 'theme_five' || $settings->theme_version == 'theme_three' || $settings->theme_version == 'multipurpose' || $settings->theme_version == 'multipurpose_two' || $settings->theme_version == 'theme_four')
                ...
                @endif
                 @if($settings->theme_version == 'theme_five' || $settings->theme_version == 'multipurpose' || $settings->theme_version == 'multipurpose_two')
                ...
                @endif
                @if($settings->theme_version == 'theme_four' || $settings->theme_version == 'multipurpose' || $settings->theme_version == 'multipurpose_two')
                ...
                @endif
                 @if($settings->theme_version == 'multipurpose_two' || $settings->theme_version == 'theme_three')
