...
@section('content')
  <main>
    ...
    @if ($websiteInfo->home_version == 'static')
        @includeIf('frontend.theme_one_two.hero_two.static')
    @elseif ($websiteInfo->home_version == 'slider')
        @includeIf('frontend.theme_one_two.hero_two.slider')
    @elseif ($websiteInfo->home_version == 'video')
        @includeIf('frontend.theme_one_two.hero_two.video')
    @elseif ($websiteInfo->home_version == 'particles')
        @includeIf('frontend.theme_one_two.hero_two.particles')
    @elseif ($websiteInfo->home_version == 'water')
        @includeIf('frontend.theme_one_two.hero_two.water')
    @elseif ($websiteInfo->home_version == 'parallax')
        @includeIf('frontend.theme_one_two.hero_two.parallax')
    @elseif ($websiteInfo->home_version == 'single_purpose')
        @includeIf('frontend.theme_one_two.hero_two.static')
    @endif
    ...
    <section class="feature-section-two" style="display:none">
