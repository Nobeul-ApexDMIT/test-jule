        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="packages-details-wrapper">
              ...
              @if (count($locations) > 0)
                <div class="places-box box-wrap" style="display:none">
              ...
              @if ($details->package->pricing_type != 'negotiable')
                <div class="review-area box-wrap {{ $status->package_rating_status == 0 ? 'd-none' : '' }}" style="display:none">
              ...
              @if ($status->package_rating_status == 1)
                @guest('web')
                  <h4 style="display:none"><a href="{{ route('user.login', ['redirectPath' => 'package_details']) }}">{{ __('Login') }}</a>
                    {{ __('To Give Your Review') }}.</h4>
                @endguest

                @auth('web')
                  @if ($details->package->pricing_type != 'negotiable')
                    <div class="review-form box-wrap" style="display:none">
          ...
          <div class="col-lg-4">
            <div class="packages-sidebar">
              ...
              <div
                class="widget booking-widget {{ $details->package->pricing_type == 'negotiable' ? 'd-none' : '' }}" style="display:none">
              ...
              @if (!is_null($details->package->email) || !is_null($details->package->phone))
                <div class="widget information-widget">
                  <h4 class="widget-title">{{ __('Contact for Booking') }}</h4>
                  <ul class="list">
              ...
              <div class="widget latest-package-widget" style="display:none">
