...
use App\Http\Controllers\FrontEnd\EventsAndLoyaltyController;
...
Route::middleware('language')->group(function () {
  ...
  Route::get('/accommodations', [RoomController::class, 'rooms'])->name('rooms');
...
Route::get('/room_booking/mercadopago/notify', [MercadoPagoController::class, 'notify'])->name('room_booking.mercadopago.notify');
...
Route::middleware('language')->group(function () {
  ...
  Route::match(['GET', 'POST'], '/contact-us', [ContactusController::class, 'contactUs'])->name('contactus');

  Route::match(['GET', 'POST'], '/book-now', [BooknowController::class, 'bookNow'])->name('booknow');
  
  Route::get('/affiliate-program', [AffiliateProgramController::class, 'index']);

  Route::get('/events-and-meetings', [EventsAndLoyaltyController::class, 'events']);

  Route::get('/privilege-program', [EventsAndLoyaltyController::class, 'loyalty'])->name('privilege-program');
  
  Route::match(['GET', 'POST'], '/affiliate-program-contact-form', [AffiliateProgramController::class, 'contactForm']);
...
Route::get('/package_booking/mercadopago/notify', [PackageMercadoPagoController::class, 'notify'])->name('package_booking.mercadopago.notify');
...
Route::prefix('/admin')->middleware(['auth:admin', 'lfm.path'])->group(function () {
  ...
  Route::post('/summernote/upload-image', [SummernoteController::class, 'upload']);

  // summernote remove image
  Route::post('/summernote/remove-image', [SummernoteController::class, 'remove']);
  ...
  Route::group(['middleware' => 'checkpermission:Home Page Sections'], function () {
    ...
    Route::get('/home_page/room_category_section', [SectionHeadingController::class, 'roomCategorySection'])->name('admin.home_page.room_category_section');

    Route::post('/home_page/update_room_category_section/{language}', [SectionHeadingController::class, 'updateRoomCategorySection'])->name('admin.home_page.update_room_category_section');

    Route::get('/home_page/room_latest_section', [SectionHeadingController::class, 'roomLatestSection'])->name('admin.home_page.room_latest_section');

    Route::post('/home_page/update_room_latest_section/{language}', [SectionHeadingController::class, 'updateRoomLatestSection'])->name('admin.home_page.update_room_latest_section');

    Route::get('/home_page/package_category_section', [SectionHeadingController::class, 'packageCategorySection'])->name('admin.home_page.package_category_section');

    Route::post('/home_page/update_package_category_section/{language}', [SectionHeadingController::class, 'updatePackageCategorySection'])->name('admin.home_page.update_package_category_section');

    Route::get('/home_page/package_latest_section', [SectionHeadingController::class, 'packageLatestSection'])->name('admin.home_page.package_latest_section');

    Route::post('/home_page/update_package_latest_section/{language}', [SectionHeadingController::class, 'updatePackageLatestSection'])->name('admin.home_page.update_package_latest_section');
  ...
  Route::group(['middleware' => 'checkpermission:Rooms Management'], function () {
    ...
    Route::post('/rooms_management/update/featured/category/status', [AdminRoomController::class, 'featuredCategory'])->name('admin.rooms_management.update.featured.status');
  ...
  Route::group(['middleware' => 'checkpermission:Packages Management'], function () {
    ...
    Route::post('/packages_management/udpate/feature/category/status', [AdminPackageController::class, 'featureCategory'])->name('admin.packages_management.update.feature.category.status');
